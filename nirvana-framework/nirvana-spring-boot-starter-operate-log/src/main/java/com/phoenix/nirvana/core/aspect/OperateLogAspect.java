package com.phoenix.nirvana.core.aspect;
...
import com.phoenix.nirvana.common.util.monitor.TracerUtils;
...
import com.phoenix.nirvana.core.service.OperateLogBO;
...
import static com.phoenix.nirvana.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static com.phoenix.nirvana.common.exception.enums.GlobalErrorCodeConstants.SUCCESS;
...
public class OperateLogAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint, ApiOperation apiOperation) throws Throwable {
        ...
        log.info("userId:{},IP:{},method:{},requestUri:{},param:{}",
                WebFrameworkUtils.getLoginUserId(),
                ServletUtil.getClientIP(ServletUtils.getRequest()),
                ServletUtils.getRequest().getMethod(),
                ServletUtils.getRequest().getRequestURI(),
                obtainMethodArgs(joinPoint)
        );
...
//        }
        if (argValues != null && argValues.length > 0) {
            return JsonUtils.toJsonString(argValues);
        }
        return "";
    }
