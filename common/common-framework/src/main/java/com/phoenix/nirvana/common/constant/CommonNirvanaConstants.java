...
public interface CommonNirvanaConstants {
     ...
     *
     * 考虑到 nirvana-spring-boot-starter-web 不依赖 nirvana-spring-boot-starter-security，但是又希望拿到认证过的用户编号，
     * 因此通过 Request 的 Attribute 进行共享
     */
    String REQUEST_ATTR_USER_ID_KEY = "nirvana_user_id";
    /**
     * HTTP Request Attr - 用户类型
     *
     * 作用同 {@link #REQUEST_ATTR_USER_ID_KEY}
     */
    String REQUEST_ATTR_USER_TYPE_KEY = "nirvana_user_type";
     ...
     */
    String REQUEST_ATTR_COMMON_RESULT = "nirvana_common_result";
    /**
