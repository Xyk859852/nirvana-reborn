...
//    }
    ...
    public static void main(String[] args) {
        ...
        GlobalConfig gc = new GlobalConfig.Builder()
                ...
                .enableSwagger()
                .fileOverride()
                .outputDir(projectPath + "/nirvana-module-mall/mall-market/mall-market-biz/src/main/java")
                .dateType(DateType.ONLY_DATE)
                .build();

        // 包配置
        PackageConfig pc = new PackageConfig.Builder()
                .parent("com.phoenix.nirvana.market")
                .controller("controller.coupon")
                .service("service.coupon")
                .serviceImpl("service.coupon.impl")
                .mapper("dal.mysql.mapper.coupon")
                .entity("dal.mysql.dataobject.coupon")
                .pathInfo(Collections.singletonMap(OutputFile.xml, projectPath + "/nirvana-module-mall/mall-market/mall-market-biz/src/main/resources/mapper"))
                .build();


        // 策略配置
        StrategyConfig strategy = new StrategyConfig.Builder()
                .addInclude("market_coupon")
                .enableCapitalMode()
                .entityBuilder()
                .formatFileName("%sDO")
