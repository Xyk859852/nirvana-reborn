...
//    }
    ...
    public static void main(String[] args) {
        ...
        GlobalConfig gc = new GlobalConfig.Builder()
                ...
                .enableSwagger()
                .fileOverride()
                .outputDir(projectPath + "/nirvana-module-mall/mall-product/mall-product-biz/src/main/java")
                .dateType(DateType.ONLY_DATE)
                .build();

        // 包配置
        PackageConfig pc = new PackageConfig.Builder()
                .parent("com.phoenix.nirvana.product")
                .controller("controller.catalog")
                .service("service.catalog")
                .serviceImpl("service.catalog.impl")
                .mapper("dal.mysql.mapper.catalog")
                .entity("dal.mysql.dataobject.catalog")
                .pathInfo(Collections.singletonMap(OutputFile.xml, projectPath + "/nirvana-module-mall/mall-product/mall-product-biz/src/main/resources/mapper"))
                .build();


        // 策略配置
        StrategyConfig strategy = new StrategyConfig.Builder()
                .addInclude("product_catalog")
                .enableCapitalMode()
                .entityBuilder()
                .formatFileName("%sDO")
